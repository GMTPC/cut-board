            ...
            <div class="panel-body">
                ...
                <div class="container-fluid">
                    ...
                    @if (Auth::user()->name == 'Manager' || Auth::user()->name == 'arnut')
                        ...
                        <table id="datecolortable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th class="text-center">#</th>
                                    <th class="text-center">สีวันที่ผลิต</th>
                            ...
                            <tbody>
                                @foreach ($detail as $detail)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $detail->wcd_color }}</td>
                                        <td class="text-center">{{ $detail->wcd_remark }}</td>
